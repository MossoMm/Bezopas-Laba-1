...
void program3() {
    ...
    // ✅ 5. Проверка: вывод в десятичной системе для верификации (опционально)
